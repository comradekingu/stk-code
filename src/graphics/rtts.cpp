...
RTT::RTT(size_t width, size_t height, float rtt_scale)
{
    ...
    RenderTargetTextures[RTT_MLAA_COLORS] = generateRTT(res, rgba_internal_format, rgb_format, type);
    RenderTargetTextures[RTT_MLAA_TMP] = generateRTT(res, rgba_internal_format, rgb_format, type);
    RenderTargetTextures[RTT_MLAA_BLEND] = generateRTT(res, rgba_internal_format, rgb_format, type);
